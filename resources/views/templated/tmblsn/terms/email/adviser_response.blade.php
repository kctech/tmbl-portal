...
@section('content')
    ...
    <p>
        ...
        <strong>3rd Party Intermediary:</strong> {{$details['fields']['client']->comm_thirdparty_consent}}<br />
    ...
    <p>
        ...
        <strong>Accept 3rd Party Intermediary:</strong> {{$details['fields']['client']->mkt_thirdparty_consent}}<br />
