...
@section('title', 'TMBL | SDLT Disclaimer')

@section('preheader')
    The SDLT Disclaimer has been sent to the client: {{$details['fields']['client']->email}}
@endsection
...
@section('content')
    ...
    <p>The SDLT Disclaimer has been sent to the client below. If they do not receive it, their unique links are also below:</p>
    ...
    <p>
        ...
        <strong>Link:</strong> {{signedRoute('sdlt-consent.respond',['code'=>$details['fields']['client']->uid, 'id'=>$details['fields']['record']->id])}}<br />
    </p>
