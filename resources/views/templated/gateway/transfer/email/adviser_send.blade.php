...
@section('content')
    ...
    <p>The Client Transfer (from The Mortgage Broker) request have been sent to the clients below. If they do not receive them, their unique links are also below:</p>
