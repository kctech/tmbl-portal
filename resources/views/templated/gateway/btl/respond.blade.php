                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="card h-100">
                                    <div class="card-body h-100">
                                        ...
                                        <p class="mb-0">I understand that Gateway Mortgages Ltd cannot provide me with tax advice, and I have sought advice (or will be seeking advice)
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card card-body bg-light">
                                        ...
                                        <p>We at Gateway Mortgages would like to stay in touch with you about products, news and special offers, which we do via services like our monthly newsletter.</p>
