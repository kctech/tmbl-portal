...
@section('title', 'Gateway Mortgages | Thank You')
...
@section('banner_img','https://tmblportal.co.uk/img/'.$details['fields']['adviser']->account->viewset.'/email/gateway_header_banner_thanks.jpg')

@section('banner_img_m','https://tmblportal.co.uk/img/'.$details['fields']['adviser']->account->viewset.'/email/gateway_header_banner_thanks_m.jpg')
