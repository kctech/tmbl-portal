                            ...
                            <div class="card bg-light mb-3">
                                <div class="card-body no-scroll-box">
                                    ...
                                    <table class="table table-bordered bg-white">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    3-5 The Bardfield Centre, Braintree Rd, Great Bardfield, CM7 4SL
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered bg-white">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($record->amount == 0 && $record->amount_2 == 0)
                                            ...
                                            <tr>
                                                <td class="bg-dark text-white">
                                                    Fees paid by you for arranging this mortgage
                                                </td>
                                                <td>
                                                    @if($record->amount == 0 && $record->amount_2 == 0)
                                                        No fee
                                                    @else
                                                        ...
                                                        @if($record->amount_2 > 0)
                                                            <br />And<br />

                                                            @if($record->type_2 == "Percentage")
                                                                {{ $record->amount_2 }}%
                                                            @else
                                                                &pound;{{ number_format($record->amount_2, 2, '.', '') }}
                                                            @endif
                                                            @if($record->timing_2 == "Application")
                                                                paid on application of the mortgage
                                                            @elseif($record->timing_2 == "Offer")
                                                                paid on receipt of the mortgage offer
                                                            @elseif($record->timing_2 == "Completion")
                                                                paid on completion of the mortgage (i.e. when the funds are drawn down) 
                                                            @endif
                                    ...
                                    <div class="card mb-3 bg-primary text-white">
                                        <div class="card-header">
                                            <ul>
                                                <li>I / We confirm that I / we have received a copy of the Terms of Business document, the Client Privacy Notice,
                                                    any relevant guides, and agree to the terms therein
                                                <li>I / We confirm we have understood the remuneration outlined and agree to any fee specified
                                                    above as being payable by me / us</li>
