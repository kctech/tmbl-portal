...
@section('body')
    ...
    <p>
        <strong>Consent to use information directly:</strong> {{$details['fields']['record']->consent}}<br />
        <strong>Response Date:</strong> {{$details['fields']['record']->updated_at}}<br />
    </p>
    
    <p>
        <strong>Consent to use information for protection advice:</strong> {{$details['fields']['client']->consent_additional}}<br />
    </p>
