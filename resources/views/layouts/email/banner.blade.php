                ...
                <td align="center" valign="top">
                            ...
                            <td align="center" valign="top">
                                    ...
                                    <tr>
                                        <td align="center">
                                            ...
                                            <table width="640" cellpadding="0" cellspacing="0" border="0" class="container">
                                                <tr>
                                                    <td style="text-decoration: none; text-align: left; font-family: 'Verdana', sans-serif;font-size: 10px; color:#222222;" valign="middle">
                                                        @yield('header')
                                                        <br />
                                                        <br />
                                                    ...
                                                    <td style="text-decoration: none; text-align: right; font-family: 'Verdana', sans-serif;font-size: 10px;" valign="middle">
                                ...
                                <div class="mobileOn" style="font-size: 0; max-height: 0; overflow: hidden; display: none">
                                    <table width="320" cellspacing="0" cellpadding="0" border="0" class="wrapper" align="center">
                                        <tr>
                                            <td style="text-decoration: none; text-align: center; font-family: 'Verdana', sans-serif;font-size: 10px; color:#222222;" valign="middle">
                                                @yield('header')
                                                <br />
                                                <br />
                                                <a href="@yield('link','https://themortgagebroker.co.uk')" style="color: #233c7c; text-decoration:underline; font-weight:bold; display: block;">
                                ...
                                <table width="640" cellpadding="0" cellspacing="0" border="0" class="container">
                                    <tr>
                                        <td width="600" class="mobile">
                                            <a href="@yield('link','https://themortgagebroker.co.uk')" target="_blank"><img src="@yield('banner_img','https://tmblportal.co.uk/img/TMBL/email/tmbl_header_banner.jpg')" alt="@yield('header')" width="640" height="235" style="margin:0; padding:0; border:none; display:block;" border="0" class="imgClass"></a>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div class="mobileOn" style="font-size: 0; max-height: 0; overflow: hidden; display: none">
                        <table width="320" cellspacing="0" cellpadding="0" border="0" class="wrapper" align="center">
                            <tr>
                                <td align="center">
                                    <a href="@yield('link','https://themortgagebroker.co.uk')" target="_blank"><img src="@yield('banner_img_m','https://tmblportal.co.uk/img/TMBL/email/tmbl_header_banner_m.jpg')" alt="@yield('header')" width="320" height="400" style="margin:0; padding:0; border:none; display:block;" border="0" class="imgClass"></a>
                                </td>
                            </tr>
                        </table>
                    </div>
