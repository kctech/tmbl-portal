...
@section('preheader')
    Please consent to us using your data.
@endsection
...
@section('link', route('gdpr-consent.respond',[$details['fields']['client']->uid,$details['fields']['record']->id]))

@section('banner_img','https://themortgagebroker.co.uk/assets/consent-admin/img/tmbl_header_banner.jpg')

@section('banner_img_m','https://themortgagebroker.co.uk/assets/consent-admin/img/tmbl_header_banner_m.jpg')
    ...
    <table align="center" width="50%">
        <tr>
            <td style="background-color: #233c7c; border-radius: 5px 5px 5px 5px; padding: 10px; color: #ffffff; text-decoration: none; text-align: center; font-family: 'Verdana', sans-serif;font-size: 12px;" class="button">
                <a href="{{route('gdpr-consent.respond',[$details['fields']['client']->uid,$details['fields']['record']->id])}}" style="color: #ffffff; text-decoration:none; font-weight:bold; display: block;">
...
@section('footer')
    Trouble displaying this email? <a href="{{route('gdpr-consent.respond',[$details['fields']['client']->uid,$details['fields']['record']->id])}}" target="_blank" style="color: #666666; text-decoration: none;">View it in your browser</a>
@endsection
